                        ...
                        if product.virtual_available > (
                            ...
                            for route in product.route_ids:
                                if route.name == 'Buy':
                                    ...
                                    template_id3 = self.env['product.template'].search(
                                        [('id', '=', component.product_id.product_tmpl_id.id)])
                                    # mrp_production_id3 = self.env['mrp.bom'].search([('product_tmpl_id', '=', template_id3.id)])
                                    mrp_production_id3 = self.env['mrp.bom'].search(
                                    ...
                                    for compon in prod_bill_of_material.bom_line_ids:
                                        ...
                                        for rou in compon.product_id.route_ids:
                                            if compon.product_id.virtual_available > ((compon.product_qty * (
                                                ...
                                                if rou.name == 'Buy':
                                                    if compon.product_id.virtual_available < 0:
                                                        vals = {
                                                            ...
                                                            'order_line': [(0, 0, {'product_id': compon.product_id.id,
                                                                                   'product_qty': -1 * (
                                                                                       compon.product_id.virtual_available),
                                                                                   'product_uom': 1,
                                                                                   'price_unit': 0,
                                                    ...
                                                    template_id4 = self.env['product.template'].search(
                                                        [('id', '=', compon.product_id.product_tmpl_id.id)])
                                                    # mrp_production_id4 = self.env['mrp.bom'].search([('product_tmpl_id', '=', template_id4.id)])
                                                    mrp_production_id4 = self.env['mrp.bom'].search(
                                                    ...
                                                    res = self.env['mrp.production'].create(
                                                        {
                                                            ...
                                                            'product_qty': (compon.product_qty * (
                                                                        component.product_qty * rec.product_qty)) - compon.product_id.virtual_available,
                                                            'check_procurement': True,

                                                        })
                                                    vendor_list3 = []
                                                    prod_template_id2 = self.env['product.template'].search(
                                                        [('id', '=', compon.product_id.product_tmpl_id.id)])
                                                    # prod_bill_of_material2 = self.env['mrp.bom'].search([('product_tmpl_id', '=', prod_template_id2.id)])
                                                    prod_bill_of_material2 = self.env['mrp.bom'].search(
                                                        [('product_id', '=', compon.product_id.id)])
                                                    for compon2 in prod_bill_of_material2.bom_line_ids:
                                                        ...
                                                        for rou2 in compon2.product_id.route_ids:
                                                            if compon2.product_id.virtual_available > ((
                                                                                                               compon2.product_qty * (
                                                                                                               compon.product_qty * (
                                                                ...
                                                                if rou2.name == 'Buy':
                                                                            ...
                                                                            'order_line': [
                                                                                (0, 0,
                                                                                 {'product_id': compon2.product_id.id,
                                                                                  'product_qty': -1 * (
                                                                                      compon2.product_id.virtual_available),
                                                                                  'product_uom': 1,
                                                                                  'price_unit': 0,
                                                                    ...
                                                                    res = self.env['mrp.production'].create(
                                                                        {'product_id': compon2.product_id.id,
                                                                         ...
                                                                         'check_procurement': True,
                                                                         'product_qty': (compon2.product_qty * (
                                                                                     compon.product_qty * (
                                                                                         component.product_qty * rec.product_qty))) - compon2.product_id.virtual_available,
                                                                         })
                                                                    vendor_list4 = []
                                                                    prod_template_id3 = self.env[
                                                                    ...
                                                                    for compon3 in prod_bill_of_material3.bom_line_ids:
                                                                        ...
                                                                        for rou3 in compon3.product_id.route_ids:
                                                                            if compon3.product_id.virtual_available > ((
                                                                                                                               compon3.product_qty * (
                                                                                                                               compon2.product_qty * (
                                                                                                                               compon.product_qty * (
                                                                                ...
                                                                                if rou3.name == 'Buy':
                                                                                                ...
                                                                                                (0, 0,
                                                                                                 {
                                                                                                     ...
                                                                                                     'product_qty': -1 * (
                                                                                                         compon3.product_id.virtual_available),
                                                                                                     'product_uom': 1,
                                                                                                     'price_unit': 0,
                                                                                    ...
                                                                                    for compon4 in prod_bill_of_material4.bom_line_ids:
                                                                                        ...
                                                                                        for rou4 in compon4.product_id.route_ids:
                                                                                            if compon4.product_id.virtual_available > (
                                                                                                    (
                                                                                                            compon4.product_qty * (
                                                                                                            compon3.product_qty * (
                                                                                                            compon2.product_qty * (
                                                                                                                ...
                                                                                                                (0, 0,
                                                                                                                 {
                                                                                                                     ...
                                                                                                                     'product_qty': -1 * (
                                                                                                                         compon4.product_id.virtual_available),
                                                                                                                     'product_uom': 1,
                                                                                                                     'price_unit': 0,
